...
public class Constants {
    ...
    public static final String PROMETHEUS_JOB_NAME = "healenium_job";
    public static final String HEALING_ID = "healing_id";
    public static final String SESSION_KEY = "sessionkey";
    public static final String HOST_PROJECT = "hostproject";
    public static final String HEALING_TIME = "healingtime";
